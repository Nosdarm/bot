# bot/game/models/player_npc_memory.py
...
class PlayerNpcMemory(BaseModel):
    """
    Stub model for player's memory of NPCs.
    """
    ...
    def __repr__(self) -> str:
        return f"<PlayerNpcMemory(id='{self.id}', placeholder='{self.placeholder}')>"
