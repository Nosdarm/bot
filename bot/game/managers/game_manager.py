...
class GameManager:
    ...
    async def _initialize_dependent_managers(self):
        ...
        self.inventory_manager = InventoryManager(character_manager=self.character_manager, item_manager=self.item_manager); self.character_manager._inventory_manager = self.inventory_manager
        ...
        self.party_manager = PartyManager(db_service=self.db_service, settings=self._settings.get('party_settings', {}), npc_manager=self.npc_manager, character_manager=self.character_manager, combat_manager=None); self.character_manager._party_manager = self.party_manager
