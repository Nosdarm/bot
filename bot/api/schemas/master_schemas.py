...
class ResolveConflictRequest(BaseModel):
    ...
    parameters: Optional[Dict[str, Any]] = Field(default=None, description="Optional parameters specific to the chosen outcome type.", example={"loot_awarded": "gold_coins", "xp_gained": 100})
...
class LaunchEventRequest(BaseModel):
    ...
    location_id: Optional[str] = Field(default=None, description="Optional ID of the location where the event should occur.", example="location_forest_entrance")
    channel_id: Optional[str] = Field(default=None, description="Optional Discord channel ID to associate with the event or send notifications to.", example="123456789012345678")
    player_ids: Optional[List[str]] = Field(default=None, description="Optional list of player character IDs to directly involve in the event.", example=["char_player_1", "char_player_2"])
...
class CompareReportsResponse(BaseModel):
    ...
    simulation_type_1: Optional[str] = Field(default=None, description="Simulation type of the first report.", example="battle")
    simulation_type_2: Optional[str] = Field(default=None, description="Simulation type of the second report.", example="battle")
...
class LocationCharacterInfo(BaseModel):
    ...
    discord_user_id: Optional[str] = Field(default=None, description="Discord User ID of the player controlling the character.", example="123456789098765432")
...
class LocationEventInfo(BaseModel):
    ...
    name: Optional[str] = Field(default=None, description="Localized name of the event, if available.", example="Goblin Ambush")
...
class NpcDetails(BaseModel):
    ...
    location_id: Optional[str] = Field(default=None, description="ID of the NPC's current location.", example="loc_tower_top")
    location_name: Optional[str] = Field(default=None, description="Localized name of the NPC's current location.", example="Wizard's Tower - Top Floor")
    hp: Optional[float] = Field(default=None, description="Current health points of the NPC.", example=80.0)
    max_health: Optional[float] = Field(default=None, description="Maximum health points of the NPC.", example=100.0)
...
class PlayerStatsResponse(BaseModel):
    ...
    discord_user_id: Optional[str] = Field(default=None, description="Discord User ID of the player.", example="987654321012345678")
    ...
    character_class: Optional[str] = Field(default=None, description="Localized name of the character's class.", example="Rogue")
    language: Optional[str] = Field(default=None, description="Selected language for the character.", example="en")
    location_id: Optional[str] = Field(default=None, description="ID of the character's current location.", example="loc_thieves_guild")
    location_name: Optional[str] = Field(default=None, description="Localized name of the character's current location.", example="Thieves' Guild - Back Alley")
    stats: Dict[str, Any] = Field(description="Base statistics of the character.", example={"strength": 12, "dexterity": 18, "intelligence": 14})
    effective_stats: Optional[Dict[str, Any]] = Field(default=None, description="Effective statistics after considering equipment, status effects, etc.", example={"strength": 14, "dexterity": 20, "attack_power": 55})
