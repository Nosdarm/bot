...
def upgrade() -> None:
    ...
    op.create_table('pending_generations',
        ...
        sa.Column('request_params_json', postgresql.JSONB(astext_fallback=True), nullable=True),
        sa.Column('raw_ai_output_text', sa.Text(), nullable=True),
        sa.Column('parsed_data_json', postgresql.JSONB(astext_fallback=True), nullable=True),
        sa.Column('validation_issues_json', postgresql.JSONB(astext_fallback=True), nullable=True),
