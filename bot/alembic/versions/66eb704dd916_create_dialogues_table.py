...
Revision ID: 66eb704dd916
Revises: 8d782c61b644
Create Date: 2025-06-22 06:07:14.233794
...
revision: str = '66eb704dd916'
down_revision: Union[str, None] = '8d782c61b644'
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['guild_id'], ['guild_configs.guild_id'], name=op.f('fk_spells_guild_id_guild_configs'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
