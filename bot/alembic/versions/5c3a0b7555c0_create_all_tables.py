...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['leader_id'], ['players.id'], name='fk_parties_leader_player'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['current_location_id'], ['locations.id'], ),
    sa.ForeignKeyConstraint(['current_party_id'], ['parties.id'], name='fk_players_current_party'),
    sa.PrimaryKeyConstraint('id')
    )
