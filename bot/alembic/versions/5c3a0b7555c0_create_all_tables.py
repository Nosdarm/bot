...
def upgrade() -> None:
    ...
    op.create_foreign_key('fk_parties_leader_player', 'parties', 'players', ['leader_id'], ['id'])
    op.create_foreign_key('fk_players_current_party', 'players', 'parties', ['current_party_id'], ['id'])
    # ### end Alembic commands ###
def downgrade() -> None:
    """Downgrade schema."""
    op.drop_constraint('fk_parties_leader_player', 'parties', type_='foreignkey')
    op.drop_constraint('fk_players_current_party', 'players', type_='foreignkey')
    # ### commands auto generated by Alembic - please adjust! ###
