...
class SqliteAdapter:
    ...
    async def initialize_database(self) -> None:
        ...
        try:
            ...
            await self._conn.commit() # Явный коммит после всех миграций
    ...
    async def _migrate_v0_to_v1(self, cursor: Cursor) -> None:
        ...
        sql_events = '''
            CREATE TABLE IF NOT EXISTS events (
                ...
                channel_id INTEGER NULL UNIQUE,
                guild_id TEXT NOT NULL,
                current_stage_id TEXT NOT NULL,
                players TEXT DEFAULT '[]', -- JSON
                state_variables TEXT DEFAULT '{}', -- JSON
        ...
        sql_npcs = '''
            CREATE TABLE IF NOT EXISTS npcs (
                ...
                -- Уникальность NPC по имени в гильдии опциональна
                -- UNIQUE(name, guild_id)
            );
        '''
        ...
        sql_combats = '''
            CREATE TABLE IF NOT EXISTS combats (
                ...
                event_id TEXT NULL,
                location_id TEXT NULL, -- <-- ДОБАВЛЕНА КОЛОНКА location_id в combats
