    ...
    async def handle_gm(self, message: Message, args: List[str], context: Dict[str, Any]) -> None:
        ...
        if subcommand == "save_state":
            ...
            if isinstance(quest_info, dict):
                ...
                pass # Handled by QuestManager returning specific messages or None for general failure.
            ...
            if isinstance(location_info, dict):
                ...
                await send_callback(message_text_template.format(location_idea_or_template_id) if message_text_template else f"Failed to process location {location_idea_or_template_id}.")
                 ...
                 pass # Handled by LocationManager returning specific messages or None.
            ...
            if operation == "inspect":
                ...
                try:
                    ...
                    traceback.print_exc()
                    await send_callback(f"❌ An error occurred: {e}")
            else: # This else corresponds to 'if operation == "inspect":'
                pass # No 'pass' needed here if there's an await send_callback directly after.
        ...
        else: # This else corresponds to the main if/elif chain for GM subcommands
            pass
