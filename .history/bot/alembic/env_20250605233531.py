...
# ✅ Импорт всех моделей и Base
from bot.database.models import (
    Base,
    Player, Location, Event, Party, RulesConfig,
    GeneratedLocation, LocationTemplate, NPC, GeneratedNpc,
    GeneratedFaction, GeneratedQuest, Item, ItemTemplate,
    Inventory, Combat, GlobalState, Log, Relationship,
    PlayerNpcMemory, Ability, Skill, Status,
    CraftingQueue, ItemProperty, Questline, QuestStep, MobileGroup
)

# ✅ Назначение metadata
target_metadata = Base.metadata

# ✅ Отладка: убедимся, что модели загружены
print("🔥 Loaded metadata tables:", list(Base.metadata.tables.keys()))
...
print("🔥 CONNECTING TO:", context.config.get_main_option("sqlalchemy.url"))
